...
int _result = this.setTorchMode(_arg0, _arg1, _arg2);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
@Override public int connect(android.hardware.ICameraClient client, int cameraId, java.lang.String opPackageName, int clientUid, android.hardware.camera2.utils.BinderHolder device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int connectDevice(android.hardware.camera2.ICameraDeviceCallbacks callbacks, int cameraId, java.lang.String opPackageName, int clientUid, android.hardware.camera2.utils.BinderHolder device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int connectLegacy(android.hardware.ICameraClient client, int cameraId, int halVersion, java.lang.String opPackageName, int clientUid, android.hardware.camera2.utils.BinderHolder device) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int setTorchMode(java.lang.String CameraId, boolean enabled, android.os.IBinder clientBinder) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
static final int TRANSACTION_getCameraCharacteristics = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getCameraVendorTagDescriptor = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getLegacyParameters = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_supportsCameraApi = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_connectLegacy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_setTorchMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_notifySystemEvent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
}
/**
     * Keep up-to-date with frameworks/av/include/camera/ICameraService.h
     */
...
public int connect(android.hardware.ICameraClient client, int cameraId, java.lang.String opPackageName, int clientUid, android.hardware.camera2.utils.BinderHolder device) throws android.os.RemoteException;
public int connectDevice(android.hardware.camera2.ICameraDeviceCallbacks callbacks, int cameraId, java.lang.String opPackageName, int clientUid, android.hardware.camera2.utils.BinderHolder device) throws android.os.RemoteException;
...
public int connectLegacy(android.hardware.ICameraClient client, int cameraId, int halVersion, java.lang.String opPackageName, int clientUid, android.hardware.camera2.utils.BinderHolder device) throws android.os.RemoteException;
public int setTorchMode(java.lang.String CameraId, boolean enabled, android.os.IBinder clientBinder) throws android.os.RemoteException;
/**
     * Notify the camera service of a system event.  Should only be called from system_server.
     *
     * Callers require the android.permission.CAMERA_SEND_SYSTEM_EVENTS permission.
