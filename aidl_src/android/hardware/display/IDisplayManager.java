...
case TRANSACTION_requestColorTransform:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int _arg1;
_arg1 = data.readInt();
this.requestColorTransform(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
@Override public void requestColorTransform(int displayId, int colorTransformId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_requestColorTransform, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_requestColorTransform = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_createVirtualDisplay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_resizeVirtualDisplay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_setVirtualDisplaySurface = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_releaseVirtualDisplay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
}
...
public void requestColorTransform(int displayId, int colorTransformId) throws android.os.RemoteException;
// Requires CAPTURE_VIDEO_OUTPUT, CAPTURE_SECURE_VIDEO_OUTPUT, or an appropriate
// MediaProjection token for certain combinations of flags.
