...
_arg13 = new android.content.res.Configuration();
android.view.Surface _arg14;
_arg14 = new android.view.Surface();
int _result = this.relayout(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8, _arg9, _arg10, _arg11, _arg12, _arg13, _arg14);
reply.writeNoException();
reply.writeInt(_result);
if ((_arg7!=null)) {
reply.writeInt(1);
...
static final int TRANSACTION_pokeDrawLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
}
