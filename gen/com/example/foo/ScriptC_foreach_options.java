 ...
 * The source Renderscript file: /home/useradmin/aosp7.0.0r3/frameworks/compile/slang/tests/P_foreach_options/foreach_options.rs
 */

package com.example.foo;

import android.renderscript.*;
import com.example.foo.foreach_optionsBitCode;

/**
 * @hide
 */
public class ScriptC_foreach_options extends ScriptC {
    private static final String __rs_resource_name = "foreach_options";
    // Constructor
    public  ScriptC_foreach_options(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              foreach_optionsBitCode.getBitCode32(),
              foreach_optionsBitCode.getBitCode64());
