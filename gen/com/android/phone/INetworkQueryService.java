 ...
 * Original file: /media/li/old/asop/aosp/packages/services/Telephony/src/com/android/phone/INetworkQueryService.aidl
 */
...
int _arg1;
_arg1 = data.readInt();
this.startNetworkQuery(_arg0, _arg1);
return true;
}
...
/**
     ...
     */
@Override public void startNetworkQuery(com.android.phone.INetworkQueryServiceCallback cb, int phoneId) throws android.os.RemoteException
{
...
/**
     ...
     * that will be sent upon query completion.
     */
public void startNetworkQuery(com.android.phone.INetworkQueryServiceCallback cb, int phoneId) throws android.os.RemoteException;
/**
     * Tells the service that the requested query is to be ignored.
     * This may not do anything for the Query request in the
     * underlying RIL, but it ensures that the callback is removed
