 ...
 * Original file: /media/li/old/asop/aosp/packages/apps/KeyChain/support/src/com/android/keychain/tests/support/IKeyChainServiceTestSupport.aidl
 */
...
case TRANSACTION_keystoreSetPassword:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
boolean _result = this.keystoreSetPassword(_arg0);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
@Override public boolean keystoreSetPassword(java.lang.String password) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
mRemote.transact(Stub.TRANSACTION_keystoreSetPassword, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_keystoreSetPassword = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
...
public boolean keystoreSetPassword(java.lang.String password) throws android.os.RemoteException;
