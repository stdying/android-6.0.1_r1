 ...
 * @hide
 */
public class ScriptField_small_struct extends android.renderscript.Script.FieldBase {
    ...
    private  ScriptField_small_struct(RenderScript rs) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    }

    public  ScriptField_small_struct(RenderScript rs, int count) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
        init(rs, count);
    ...
    public  ScriptField_small_struct(RenderScript rs, int count, int usages) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    ...
    public static ScriptField_small_struct create1D(RenderScript rs, int dimX, int usages) {
        ScriptField_small_struct obj = new ScriptField_small_struct(rs);
        obj.mAllocation = Allocation.createSized(rs, obj.mElement, dimX, usages);
        return obj;
    }

    public static ScriptField_small_struct create1D(RenderScript rs, int dimX) {
        return create1D(rs, dimX, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_small_struct create2D(RenderScript rs, int dimX, int dimY) {
        return create2D(rs, dimX, dimY, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_small_struct create2D(RenderScript rs, int dimX, int dimY, int usages) {
        ScriptField_small_struct obj = new ScriptField_small_struct(rs);
    ...
    public static ScriptField_small_struct createCustom(RenderScript rs, Type.Builder tb, int usages) {
        ScriptField_small_struct obj = new ScriptField_small_struct(rs);
        Type t = tb.create();
