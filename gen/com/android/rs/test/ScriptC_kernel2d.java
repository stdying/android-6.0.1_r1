...
import com.android.rs.test.kernel2dBitCode;

/**
 * @hide
 */
public class ScriptC_kernel2d extends ScriptC {
    private static final String __rs_resource_name = "kernel2d";
    // Constructor
    public  ScriptC_kernel2d(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              kernel2dBitCode.getBitCode32(),
              kernel2dBitCode.getBitCode64());
    ...
    public Script.KernelID getKernelID_root() {
        return createKernelID(mExportForEachIdx_root, 187, null, null);
    }
