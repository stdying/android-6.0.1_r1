...
import com.android.rs.test.kernel3dBitCode;

/**
 * @hide
 */
public class ScriptC_kernel3d extends ScriptC {
    private static final String __rs_resource_name = "kernel3d";
    // Constructor
    public  ScriptC_kernel3d(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              kernel3dBitCode.getBitCode32(),
              kernel3dBitCode.getBitCode64());
    ...
    private final static int mExportVarIdx_gDimZ = 4;
    private long mExportVar_gDimZ;
    public synchronized void set_gDimZ(long v) {
        if (__rs_fp_U32!= null) {
            __rs_fp_U32.reset();
        } else {
            __rs_fp_U32 = new FieldPacker(4);
        ...
        __rs_fp_U32.addU32(v);
        setVar(mExportVarIdx_gDimZ, __rs_fp_U32);
        mExportVar_gDimZ = v;
    }

    public long get_gDimZ() {
    ...
    public Script.KernelID getKernelID_root() {
        return createKernelID(mExportForEachIdx_root, 251, null, null);
    }
