...
import com.android.rs.test.ctxt_defaultBitCode;

/**
 * @hide
 */
public class ScriptC_ctxt_default extends ScriptC {
    private static final String __rs_resource_name = "ctxt_default";
    // Constructor
    public  ScriptC_ctxt_default(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              ctxt_defaultBitCode.getBitCode32(),
              ctxt_defaultBitCode.getBitCode64());
    ...
    public Script.KernelID getKernelID_root() {
        return createKernelID(mExportForEachIdx_root, 171, null, null);
    }
