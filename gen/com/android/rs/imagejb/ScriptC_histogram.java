...
import com.android.rs.imagejb.histogramBitCode;
...
public class ScriptC_histogram extends ScriptC {
    ...
    public Script.KernelID getKernelID_pass1() {
        return createKernelID(mExportForEachIdx_pass1, 40, null, null);
    }

    public void forEach_pass1(Script.LaunchOptions sc) {
        forEach(mExportForEachIdx_pass1, (Allocation) null, null, null, sc);
    }
