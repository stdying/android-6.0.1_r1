 ...
 * The source Renderscript file: /media/li/old/asop/aosp/frameworks/rs/java/tests/ScriptGroupTest/src/com/android/rs/sgtest/greyscale_f.rs
 */

package com.android.rs.sgtest;

import android.renderscript.*;
import com.android.rs.sgtest.greyscale_fBitCode;

/**
 * @hide
 */
public class ScriptC_greyscale_f extends ScriptC {
    private static final String __rs_resource_name = "greyscale_f";
    // Constructor
    public  ScriptC_greyscale_f(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              greyscale_fBitCode.getBitCode32(),
              greyscale_fBitCode.getBitCode64());
