...
import com.android.rs.test_compatlegacy.array_allocBitCode;
...
public class ScriptC_array_alloc extends ScriptC {
    ...
    public Script.InvokeID getInvokeID_array_alloc_test() {
        return createInvokeID(mExportFuncIdx_array_alloc_test);
    }
