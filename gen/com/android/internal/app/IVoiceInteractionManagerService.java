 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/core/java/com/android/internal/app/IVoiceInteractionManagerService.aidl
 */
...
static final int TRANSACTION_setKeepAwake = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_closeSystemDialogs = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_finish = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_setDisabledShowContext = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getDisabledShowContext = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getUserDisabledShowContext = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getKeyphraseSoundModel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_updateKeyphraseSoundModel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_deleteKeyphraseSoundModel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_getDspModuleProperties = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_isEnrolledForKeyphrase = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_startRecognition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_stopRecognition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_getActiveServiceComponentName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_showSessionForActiveService = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_hideCurrentSession = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_launchVoiceAssistFromKeyguard = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_isSessionRunning = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_activeServiceSupportsAssist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_activeServiceSupportsLaunchFromKeyguard = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_onLockscreenShown = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
}
