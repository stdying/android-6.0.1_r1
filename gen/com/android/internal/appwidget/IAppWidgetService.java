 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/core/java/com/android/internal/appwidget/IAppWidgetService.aidl
 */
...
@Override public android.content.pm.ParceledListSlice getInstalledProvidersForProfile(int categoryFilter, int profileId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
public android.content.pm.ParceledListSlice getInstalledProvidersForProfile(int categoryFilter, int profileId) throws android.os.RemoteException;
