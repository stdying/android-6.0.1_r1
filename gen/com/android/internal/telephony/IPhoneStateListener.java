 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/telephony/java/com/android/internal/telephony/IPhoneStateListener.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_onCarrierNetworkChange, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_onCarrierNetworkChange = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
}
