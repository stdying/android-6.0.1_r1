 ...
 * Original file: /home/useradmin/aosp7.0.0r3/frameworks/base/telephony/java/com/android/ims/internal/uce/presence/IPresenceService.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_reenableService, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.android.ims.internal.uce.common.StatusCode.CREATOR.createFromParcel(_reply);
}
...
_data.writeInt(userData);
mRemote.transact(Stub.TRANSACTION_publishMyCap, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.android.ims.internal.uce.common.StatusCode.CREATOR.createFromParcel(_reply);
}
...
_data.writeInt(userData);
mRemote.transact(Stub.TRANSACTION_getContactCap, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.android.ims.internal.uce.common.StatusCode.CREATOR.createFromParcel(_reply);
}
...
_data.writeInt(userData);
mRemote.transact(Stub.TRANSACTION_getContactListCap, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.android.ims.internal.uce.common.StatusCode.CREATOR.createFromParcel(_reply);
}
...
_data.writeInt(userData);
mRemote.transact(Stub.TRANSACTION_setNewFeatureTag, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.android.ims.internal.uce.common.StatusCode.CREATOR.createFromParcel(_reply);
}
