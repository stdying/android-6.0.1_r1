 ...
 * Original file: /home/useradmin/aosp7.0.0r3/frameworks/base/telephony/java/com/android/ims/internal/uce/options/IOptionsService.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_setMyInfo, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.android.ims.internal.uce.common.StatusCode.CREATOR.createFromParcel(_reply);
}
...
_data.writeInt(optionsServiceHandle);
_data.writeInt(reqUserdata);
mRemote.transact(Stub.TRANSACTION_getMyInfo, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.android.ims.internal.uce.common.StatusCode.CREATOR.createFromParcel(_reply);
}
...
mRemote.transact(Stub.TRANSACTION_responseIncomingOptions, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.android.ims.internal.uce.common.StatusCode.CREATOR.createFromParcel(_reply);
}
