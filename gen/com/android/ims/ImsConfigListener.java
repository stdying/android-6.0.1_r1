 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/telephony/java/com/android/ims/ImsConfigListener.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_onGetVideoQuality, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(status);
mRemote.transact(Stub.TRANSACTION_onSetVideoQuality, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
