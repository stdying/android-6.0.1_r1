 ...
 * The source Renderscript file: /home/useradmin/aosp7.0.0r3/frameworks/compile/slang/tests/F_one_definition_rule5/def2.rs
 */
 ...
 * @hide
 */
public class ScriptField_DifferentDefinition5 extends android.renderscript.Script.FieldBase {
    ...
    private  ScriptField_DifferentDefinition5(RenderScript rs) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    }

    public  ScriptField_DifferentDefinition5(RenderScript rs, int count) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
        init(rs, count);
    ...
    public  ScriptField_DifferentDefinition5(RenderScript rs, int count, int usages) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    ...
    public static ScriptField_DifferentDefinition5 create1D(RenderScript rs, int dimX, int usages) {
        ScriptField_DifferentDefinition5 obj = new ScriptField_DifferentDefinition5(rs);
        obj.mAllocation = Allocation.createSized(rs, obj.mElement, dimX, usages);
        return obj;
    }

    public static ScriptField_DifferentDefinition5 create1D(RenderScript rs, int dimX) {
        return create1D(rs, dimX, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_DifferentDefinition5 create2D(RenderScript rs, int dimX, int dimY) {
        return create2D(rs, dimX, dimY, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_DifferentDefinition5 create2D(RenderScript rs, int dimX, int dimY, int usages) {
        ScriptField_DifferentDefinition5 obj = new ScriptField_DifferentDefinition5(rs);
    ...
    public static ScriptField_DifferentDefinition5 createCustom(RenderScript rs, Type.Builder tb, int usages) {
        ScriptField_DifferentDefinition5 obj = new ScriptField_DifferentDefinition5(rs);
        Type t = tb.create();
