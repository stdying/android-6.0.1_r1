...
public class ScriptC_array_init extends ScriptC {
    ...
    public  ScriptC_array_init(RenderScript rs) {
        ...
        mExportVar_implicitArray = new byte[3];
        mExportVar_implicitArray[0] = 97;
        mExportVar_implicitArray[1] = 98;
        mExportVar_implicitArray[2] = 99;
    }
    ...
    private final static int mExportVarIdx_implicitArray = 10;
    private byte[] mExportVar_implicitArray;
    public synchronized void set_implicitArray(byte[] v) {
        mExportVar_implicitArray = v;
        FieldPacker fp = new FieldPacker(3);
        for (int ct1 = 0; ct1 < 3; ct1++) {
            fp.addI8(v[ct1]);
        }
        ...
        int []__dimArr = new int[1];
        __dimArr[0] = 3;
        setVar(mExportVarIdx_implicitArray, fp, __I8, __dimArr);
    }

    public byte[] get_implicitArray() {
        return mExportVar_implicitArray;
    }

    public Script.FieldID getFieldID_implicitArray() {
        return createFieldID(mExportVarIdx_implicitArray, null);
    }

    private final static int mExportVarIdx_implicitArrayUninit = 11;
    private byte[] mExportVar_implicitArrayUninit;
    public synchronized void set_implicitArrayUninit(byte[] v) {
        mExportVar_implicitArrayUninit = v;
        ...
        int []__dimArr = new int[1];
        __dimArr[0] = 1;
        setVar(mExportVarIdx_implicitArrayUninit, fp, __I8, __dimArr);
    }

    public byte[] get_implicitArrayUninit() {
        return mExportVar_implicitArrayUninit;
    }

    public Script.FieldID getFieldID_implicitArrayUninit() {
        return createFieldID(mExportVarIdx_implicitArrayUninit, null);
    }
