...
import foo.ooo_computeBitCode;

/**
 * @hide
 */
public class ScriptC_ooo_compute extends ScriptC {
    private static final String __rs_resource_name = "ooo_compute";
    // Constructor
    public  ScriptC_ooo_compute(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              ooo_computeBitCode.getBitCode32(),
              ooo_computeBitCode.getBitCode64());
