 ...
 * The source Renderscript file: /home/useradmin/aosp7.0.0r3/frameworks/compile/slang/lit-tests/opt/locals_opt_0.rs
 */

package foo;

import android.renderscript.*;
import foo.locals_opt_0BitCode;

/**
 * @hide
 */
public class ScriptC_locals_opt_0 extends ScriptC {
    private static final String __rs_resource_name = "locals_opt_0";
    // Constructor
    public  ScriptC_locals_opt_0(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              locals_opt_0BitCode.getBitCode32(),
              locals_opt_0BitCode.getBitCode64());
