 ...
 * The source Renderscript file: /home/useradmin/aosp7.0.0r3/frameworks/compile/slang/tests/F_one_definition_rule3/def2.rs
 */
 ...
 * @hide
 */
public class ScriptField_DifferentDefinition3 extends android.renderscript.Script.FieldBase {
    ...
    public static Element createElement(RenderScript rs) {
        ...
        eb.add(Element.I32(rs), "member2");
        return eb.create();
    }

    private  ScriptField_DifferentDefinition3(RenderScript rs) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    }

    public  ScriptField_DifferentDefinition3(RenderScript rs, int count) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
        init(rs, count);
    ...
    public  ScriptField_DifferentDefinition3(RenderScript rs, int count, int usages) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    ...
    public static ScriptField_DifferentDefinition3 create1D(RenderScript rs, int dimX, int usages) {
        ScriptField_DifferentDefinition3 obj = new ScriptField_DifferentDefinition3(rs);
        obj.mAllocation = Allocation.createSized(rs, obj.mElement, dimX, usages);
        return obj;
    }

    public static ScriptField_DifferentDefinition3 create1D(RenderScript rs, int dimX) {
        return create1D(rs, dimX, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_DifferentDefinition3 create2D(RenderScript rs, int dimX, int dimY) {
        return create2D(rs, dimX, dimY, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_DifferentDefinition3 create2D(RenderScript rs, int dimX, int dimY, int usages) {
        ScriptField_DifferentDefinition3 obj = new ScriptField_DifferentDefinition3(rs);
    ...
    public static ScriptField_DifferentDefinition3 createCustom(RenderScript rs, Type.Builder tb, int usages) {
        ScriptField_DifferentDefinition3 obj = new ScriptField_DifferentDefinition3(rs);
        Type t = tb.create();
    ...
    public synchronized void set_member2(int index, int v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
    ...
    public synchronized int get_member2(int index) {
        if (mItemArray == null) return 0;
