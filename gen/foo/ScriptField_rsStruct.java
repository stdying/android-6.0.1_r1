 ...
 * @hide
 */
public class ScriptField_rsStruct extends android.renderscript.Script.FieldBase {
    ...
    private  ScriptField_rsStruct(RenderScript rs) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    }

    public  ScriptField_rsStruct(RenderScript rs, int count) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
        init(rs, count);
    ...
    public  ScriptField_rsStruct(RenderScript rs, int count, int usages) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    ...
    public static ScriptField_rsStruct create1D(RenderScript rs, int dimX, int usages) {
        ScriptField_rsStruct obj = new ScriptField_rsStruct(rs);
        obj.mAllocation = Allocation.createSized(rs, obj.mElement, dimX, usages);
        return obj;
    }

    public static ScriptField_rsStruct create1D(RenderScript rs, int dimX) {
        return create1D(rs, dimX, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_rsStruct create2D(RenderScript rs, int dimX, int dimY) {
        return create2D(rs, dimX, dimY, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_rsStruct create2D(RenderScript rs, int dimX, int dimY, int usages) {
        ScriptField_rsStruct obj = new ScriptField_rsStruct(rs);
    ...
    public static ScriptField_rsStruct createCustom(RenderScript rs, Type.Builder tb, int usages) {
        ScriptField_rsStruct obj = new ScriptField_rsStruct(rs);
        Type t = tb.create();
