 ...
 * The source Renderscript file: /home/useradmin/aosp7.0.0r3/frameworks/compile/slang/tests/F_one_definition_rule4/def2.rs
 */
 ...
 * @hide
 */
public class ScriptField_DifferentDefinition4 extends android.renderscript.Script.FieldBase {
    ...
    public static Element createElement(RenderScript rs) {
        ...
        eb.add(Element.F32(rs), "member3");
        return eb.create();
    }

    private  ScriptField_DifferentDefinition4(RenderScript rs) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    }

    public  ScriptField_DifferentDefinition4(RenderScript rs, int count) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
        init(rs, count);
    ...
    public  ScriptField_DifferentDefinition4(RenderScript rs, int count, int usages) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    ...
    public static ScriptField_DifferentDefinition4 create1D(RenderScript rs, int dimX, int usages) {
        ScriptField_DifferentDefinition4 obj = new ScriptField_DifferentDefinition4(rs);
        obj.mAllocation = Allocation.createSized(rs, obj.mElement, dimX, usages);
        return obj;
    }

    public static ScriptField_DifferentDefinition4 create1D(RenderScript rs, int dimX) {
        return create1D(rs, dimX, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_DifferentDefinition4 create2D(RenderScript rs, int dimX, int dimY) {
        return create2D(rs, dimX, dimY, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_DifferentDefinition4 create2D(RenderScript rs, int dimX, int dimY, int usages) {
        ScriptField_DifferentDefinition4 obj = new ScriptField_DifferentDefinition4(rs);
    ...
    public static ScriptField_DifferentDefinition4 createCustom(RenderScript rs, Type.Builder tb, int usages) {
        ScriptField_DifferentDefinition4 obj = new ScriptField_DifferentDefinition4(rs);
        Type t = tb.create();
    ...
    public synchronized void set_member3(int index, float v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(mElement.getBytesSize() * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
    ...
    public synchronized float get_member3(int index) {
        if (mItemArray == null) return 0;
