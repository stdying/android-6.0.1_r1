...
import foo.locals_opt_3BitCode;

/**
 * @hide
 */
public class ScriptC_locals_opt_3 extends ScriptC {
    private static final String __rs_resource_name = "locals_opt_3";
    // Constructor
    public  ScriptC_locals_opt_3(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              locals_opt_3BitCode.getBitCode32(),
              locals_opt_3BitCode.getBitCode64());
