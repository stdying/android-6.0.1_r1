...
import foo.def1BitCode;

/**
 * @hide
 */
public class ScriptC_def1 extends ScriptC {
    private static final String __rs_resource_name = "def1";
    // Constructor
    public  ScriptC_def1(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              def1BitCode.getBitCode32(),
              def1BitCode.getBitCode64());
