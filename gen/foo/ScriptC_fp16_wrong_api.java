 ...
 * The source Renderscript file: /home/useradmin/aosp7.0.0r3/frameworks/compile/slang/tests/F_fp16_wrong_api/fp16_wrong_api.rs
 */

package foo;

import android.renderscript.*;
import foo.fp16_wrong_apiBitCode;

/**
 * @hide
 */
public class ScriptC_fp16_wrong_api extends ScriptC {
    private static final String __rs_resource_name = "fp16_wrong_api";
    // Constructor
    public  ScriptC_fp16_wrong_api(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              fp16_wrong_apiBitCode.getBitCode32(),
              fp16_wrong_apiBitCode.getBitCode64());
