 ...
 * @hide
 */
public class ScriptC_locals extends ScriptC {
    private static final String __rs_resource_name = "locals";
    // Constructor
    public  ScriptC_locals(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              localsBitCode.getBitCode32(),
              localsBitCode.getBitCode64());
