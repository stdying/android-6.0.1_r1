 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/core/java/android/accounts/IAccountManager.aidl
 */
...
static final int TRANSACTION_accountAuthenticated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getAuthTokenLabel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_addSharedAccountAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_getSharedAccountsAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_removeSharedAccountAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_renameAccount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_getPreviousName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_renameSharedAccountAsUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
}
