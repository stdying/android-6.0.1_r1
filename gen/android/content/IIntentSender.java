 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/core/java/android/content/IIntentSender.aidl
 */
...
int _result = this.send(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5);
...
@Override public int send(int code, android.content.Intent intent, java.lang.String resolvedType, android.content.IIntentReceiver finishedReceiver, java.lang.String requiredPermission, android.os.Bundle options) throws android.os.RemoteException
{
...
public int send(int code, android.content.Intent intent, java.lang.String resolvedType, android.content.IIntentReceiver finishedReceiver, java.lang.String requiredPermission, android.os.Bundle options) throws android.os.RemoteException;
}
