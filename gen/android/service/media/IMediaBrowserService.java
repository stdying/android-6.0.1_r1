 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/media/java/android/service/media/IMediaBrowserService.aidl
 */
...
@Override public void getMediaItem(java.lang.String uri, android.os.ResultReceiver cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
public void getMediaItem(java.lang.String uri, android.os.ResultReceiver cb) throws android.os.RemoteException;
}
