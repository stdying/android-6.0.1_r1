 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/core/java/android/app/trust/ITrustManager.aidl
 */
...
static final int TRANSACTION_registerTrustListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_unregisterTrustListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_reportKeyguardShowingChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_isDeviceLocked = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_isDeviceSecure = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
}
