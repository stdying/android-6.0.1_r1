 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/core/java/android/app/IWallpaperManager.aidl
 */
package android.app;
/** @hide */
...
android.os.ParcelFileDescriptor _result = this.setWallpaper(_arg0, _arg1);
...
/**
     * Set the wallpaper.
     */
@Override public android.os.ParcelFileDescriptor setWallpaper(java.lang.String name, java.lang.String callingPackage) throws android.os.RemoteException
{
...
static final int TRANSACTION_getWallpaperInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_clearWallpaper = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_hasNamedWallpaper = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_setDimensionHints = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getWidthHint = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getHeightHint = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_setDisplayPadding = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_settingsRestored = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_isWallpaperSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
}
/**
     * Set the wallpaper.
     */
public android.os.ParcelFileDescriptor setWallpaper(java.lang.String name, java.lang.String callingPackage) throws android.os.RemoteException;
/**
     * Set the live wallpaper.
     */
