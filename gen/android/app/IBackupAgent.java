 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/core/java/android/app/IBackupAgent.aidl
 */
package android.app;
/**
...
/**
     ...
     */
@Override public void doMeasureFullBackup(int token, android.app.backup.IBackupManager callbackBinder) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
static final int TRANSACTION_doRestoreFile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_doRestoreFinished = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_fail = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
}
/**
     * Request that the app perform an incremental backup.
     *
...
/**
     * Estimate how much data a full backup will deliver
     */
public void doMeasureFullBackup(int token, android.app.backup.IBackupManager callbackBinder) throws android.os.RemoteException;
/**
     * Restore a single "file" to the application.  The file was typically obtained from
     * a full-backup dataset.  The agent reads 'size' bytes of file content
     * from the provided file descriptor.
