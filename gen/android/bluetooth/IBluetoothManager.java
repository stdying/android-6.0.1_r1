 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/core/java/android/bluetooth/IBluetoothManager.aidl
 */
...
@Override public int updateBleAppCount(android.os.IBinder b, boolean enable) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
static final int TRANSACTION_isBleScanAlwaysAvailable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_updateBleAppCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_isBleAppPresent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
}
...
public int updateBleAppCount(android.os.IBinder b, boolean enable) throws android.os.RemoteException;
