 ...
 * Original file: /home/useradmin/aosp7.0.0r3/frameworks/base/core/java/android/bluetooth/IBluetoothPbapClient.aidl
 */
 ...
 * {@hide}
 */
public interface IBluetoothPbapClient extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements android.bluetooth.IBluetoothPbapClient
{
private static final java.lang.String DESCRIPTOR = "android.bluetooth.IBluetoothPbapClient";
...
/**
 * Cast an IBinder object into an android.bluetooth.IBluetoothPbapClient interface,
 * generating a proxy if needed.
 */
public static android.bluetooth.IBluetoothPbapClient asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof android.bluetooth.IBluetoothPbapClient))) {
return ((android.bluetooth.IBluetoothPbapClient)iin);
}
return new android.bluetooth.IBluetoothPbapClient.Stub.Proxy(obj);
}
...
private static class Proxy implements android.bluetooth.IBluetoothPbapClient
{
