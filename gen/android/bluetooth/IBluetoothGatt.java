 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/core/java/android/bluetooth/IBluetoothGatt.aidl
 */
...
this.startScan(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5);
reply.writeNoException();
return true;
}
...
@Override public void startScan(int appIf, boolean isServer, android.bluetooth.le.ScanSettings settings, java.util.List<android.bluetooth.le.ScanFilter> filters, java.util.List scanStorages, java.lang.String callingPackage) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_disconnectAll = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_unregAll = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_numHwTrackFiltersAvailable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
}
...
public void startScan(int appIf, boolean isServer, android.bluetooth.le.ScanSettings settings, java.util.List<android.bluetooth.le.ScanFilter> filters, java.util.List scanStorages, java.lang.String callingPackage) throws android.os.RemoteException;
