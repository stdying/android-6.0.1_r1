 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/core/java/android/bluetooth/IBluetooth.aidl
 */
...
static final int TRANSACTION_getSimAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_setSimAccessPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_sendConnectionStateChange = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_registerCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_unregisterCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_connectSocket = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_createSocketChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_configHciSnoopLog = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_factoryReset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_isMultiAdvertisementSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_isPeripheralModeSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_isOffloadedFilteringSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_isOffloadedScanBatchingSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_isActivityAndEnergyReportingSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_getActivityEnergyInfoFromController = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_reportActivityInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_dump = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_onLeServiceUp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_onBrEdrDown = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
}
