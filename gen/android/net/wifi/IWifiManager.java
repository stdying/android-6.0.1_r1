 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/wifi/java/android/net/wifi/IWifiManager.aidl
 */
...
{
data.enforceInterface(DESCRIPTOR);
android.bluetooth.le.ScanSettings _arg0;
if ((0!=data.readInt())) {
_arg0 = android.bluetooth.le.ScanSettings.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
java.util.List<android.bluetooth.le.ScanResult> _result = this.getScanResults(_arg0);
reply.writeNoException();
reply.writeTypedList(_result);
return true;
}
...
@Override public android.net.wifi.WifiConfiguration getMatchingWifiConfig(android.bluetooth.le.ScanResult scanResult) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public void startScan(android.bluetooth.le.ScanSettings requested, android.os.WorkSource ws) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public java.util.List<android.bluetooth.le.ScanResult> getScanResults(java.lang.String callingPackage) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<android.bluetooth.le.ScanResult> _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(callingPackage);
mRemote.transact(Stub.TRANSACTION_getScanResults, _data, _reply, 0);
_reply.readException();
_result = _reply.createTypedArrayList(android.bluetooth.le.ScanResult.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
public android.net.wifi.WifiConfiguration getMatchingWifiConfig(android.bluetooth.le.ScanResult scanResult) throws android.os.RemoteException;
...
public void startScan(android.bluetooth.le.ScanSettings requested, android.os.WorkSource ws) throws android.os.RemoteException;
public void startLocationRestrictedScan(android.os.WorkSource ws) throws android.os.RemoteException;
public java.util.List<android.bluetooth.le.ScanResult> getScanResults(java.lang.String callingPackage) throws android.os.RemoteException;
