 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/wifi/java/android/net/wifi/passpoint/IWifiPasspointManager.aidl
 */
...
@Override public java.util.List<android.net.wifi.passpoint.WifiPasspointPolicy> requestCredentialMatch(java.util.List<android.bluetooth.le.ScanResult> requested) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
public java.util.List<android.net.wifi.passpoint.WifiPasspointPolicy> requestCredentialMatch(java.util.List<android.bluetooth.le.ScanResult> requested) throws android.os.RemoteException;
