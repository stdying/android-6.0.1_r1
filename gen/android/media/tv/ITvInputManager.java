 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/media/java/android/media/tv/ITvInputManager.aidl
 */
...
static final int TRANSACTION_unblockContent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_timeShiftPause = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_timeShiftResume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_timeShiftSeekTo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_timeShiftSetPlaybackParams = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_timeShiftEnablePositionTracking = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_getHardwareList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_acquireTvInputHardware = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_releaseTvInputHardware = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_getAvailableTvStreamConfigList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_captureFrame = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_isSingleSessionActive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_getDvbDeviceList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_openDvbDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
}
