 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/media/java/android/media/tv/ITvInputSession.aidl
 */
...
static final int TRANSACTION_timeShiftPause = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_timeShiftResume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_timeShiftSeekTo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_timeShiftSetPlaybackParams = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_timeShiftEnablePositionTracking = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
}
