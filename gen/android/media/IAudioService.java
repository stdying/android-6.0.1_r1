 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/media/java/android/media/IAudioService.aidl
 */
...
static final int TRANSACTION_registerRemoteControlDisplay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_registerRemoteController = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_unregisterRemoteControlDisplay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_remoteControlDisplayUsesBitmapSize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_remoteControlDisplayWantsPlaybackPositionSync = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_startBluetoothSco = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_startBluetoothScoVirtualCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_stopBluetoothSco = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_forceVolumeControlStream = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_setRingtonePlayer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_getRingtonePlayer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_getUiSoundsStreamType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_setWiredDeviceConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_setBluetoothA2dpDeviceConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_startWatchingRoutes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_isCameraSoundForced = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_setVolumeController = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_notifyVolumeControllerVisible = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_isStreamAffectedByRingerMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_isStreamAffectedByMute = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
static final int TRANSACTION_disableSafeMediaVolume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
static final int TRANSACTION_setHdmiSystemAudioSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_isHdmiSystemAudioSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_registerAudioPolicy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_unregisterAudioPolicyAsync = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_setFocusPropertiesForPolicy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_setVolumePolicy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
}
