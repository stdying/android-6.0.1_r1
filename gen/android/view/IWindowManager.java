 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/core/java/android/view/IWindowManager.aidl
 */
...
@Override public void setAppTask(android.os.IBinder token, int taskId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
@Override public android.graphics.Bitmap screenshotApplications(android.os.IBinder appToken, int displayId, int maxWidth, int maxHeight) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
static final int TRANSACTION_getRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_watchRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_removeRotationWatcher = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
static final int TRANSACTION_getPreferredOptionsPanelGravity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
static final int TRANSACTION_freezeRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
static final int TRANSACTION_thawRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
static final int TRANSACTION_isRotationFrozen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
static final int TRANSACTION_requestAssistScreenshot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
static final int TRANSACTION_screenshotApplications = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
static final int TRANSACTION_statusBarVisibilityChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
static final int TRANSACTION_hasNavigationBar = (android.os.IBinder.FIRST_CALL_TRANSACTION + 73);
static final int TRANSACTION_lockNow = (android.os.IBinder.FIRST_CALL_TRANSACTION + 74);
static final int TRANSACTION_isSafeModeEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 75);
static final int TRANSACTION_enableScreenIfNeeded = (android.os.IBinder.FIRST_CALL_TRANSACTION + 76);
static final int TRANSACTION_clearWindowContentFrameStats = (android.os.IBinder.FIRST_CALL_TRANSACTION + 77);
static final int TRANSACTION_getWindowContentFrameStats = (android.os.IBinder.FIRST_CALL_TRANSACTION + 78);
}
/**
     * ===== NOTICE =====
     * The first three methods must remain the first three methods. Scripts
...
public void setAppTask(android.os.IBinder token, int taskId) throws android.os.RemoteException;
...
/**
     * Create a screenshot of the applications currently displayed.
     */
public android.graphics.Bitmap screenshotApplications(android.os.IBinder appToken, int displayId, int maxWidth, int maxHeight) throws android.os.RemoteException;
/**
     * Called by the status bar to notify Views of changes to System UI visiblity.
     */
