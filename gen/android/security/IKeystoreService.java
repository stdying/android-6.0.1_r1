 ...
 * Original file: /media/li/old/asop/aosp/frameworks/base/core/java/android/security/IKeystoreService.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements android.security.IKeystoreService
{
 ...
 */
public static android.security.IKeystoreService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
...
android.security.keymaster.OperationResult _result = this.begin(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
private static class Proxy implements android.security.IKeystoreService
{
...
@Override public android.security.keymaster.OperationResult begin(android.os.IBinder appToken, java.lang.String alias, int purpose, boolean pruneable, android.security.keymaster.KeymasterArguments params, byte[] entropy) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
public android.security.keymaster.OperationResult begin(android.os.IBinder appToken, java.lang.String alias, int purpose, boolean pruneable, android.security.keymaster.KeymasterArguments params, byte[] entropy) throws android.os.RemoteException;
